...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width,initial-scale=1, maximum-scale=1.0, minimum-scale=1.0, viewport-fit=cover, user-scalable=no"}],"link":[{"rel":"icon","href":"/favicon.ico","sizes":"any"}],"style":[],"script":[],"noscript":[]};
